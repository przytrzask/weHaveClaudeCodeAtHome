...
const debounce = <A extends any[],O>(fn: (...args: A)=> Effect.Effect<O>, duration: DurationInput, options: DebounceOptions = { mode: "trailing" }) => {
  ...
  return (...args: A) => {
    ...
    return Effect.gen(function* () {  
      ...
      const shouldCallNow = options.mode === "leading" && Duration.greaterThan(timeSinceLastCall, duration);
